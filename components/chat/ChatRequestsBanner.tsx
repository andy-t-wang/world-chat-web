...
export function ChatRequestsBanner({ count, onClick }: ChatRequestsBannerProps) {
  ...
  return (
    <button
      onClick={onClick}
      className="w-full flex items-center gap-3 px-6 py-2.5 hover:bg-gray-50 active:bg-gray-100 transition-colors"
    >
      {/* Icon */}
      <div className="w-[52px] h-[52px] rounded-full bg-[#F5F5F5] flex items-center justify-center shrink-0">
